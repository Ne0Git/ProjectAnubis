...
#include "ProjectAnubisCharacter.generated.h"

UCLASS(config=Game)
class AProjectAnubisCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	AProjectAnubisCharacter(const FObjectInitializer& ObjectInitializer);
